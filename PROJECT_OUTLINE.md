...
### 当前版本
v020（2026-07-16，阶段 3 已验收基线、团队与 Quickinput UI 规格已建立）
...
### 下一个 AI 要做什么
阶段 3 Python 宏已作为 GitHub v019 基线保存。当前 v020 只完成团队和 UI 规格文档；下一项开发任务是 Quickinput 风格四页 UI 外壳与红库主题，保持 F9/F12/OSD 行为不变，F2 只预留。
...
| 阶段3：单 Python 宏脚本引擎 | 实现与自动测试 100%，待用户验收 | 可信 Python 宏、tap/sleep、固定 F9/F12、热重载 |
