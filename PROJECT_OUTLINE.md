...
### 当前版本
v021（2026-07-16，运行与安全人工验收通过；视觉设计部分认可，等待 V022 对齐审查）
...
### 下一个 AI 要做什么
执行 V022“优秀案例 1 视觉与窗口规则对齐审查，不写 UI 代码”：逐张核对四张参考图、案例 UI 源码和当前 v021 截图，写出颜色、字体、间距、页面层级、禁用态和窗口规则的可执行差异清单。完成 RequirementCertifier 新 READY 前禁止改 UI。

### 用户需要做什么
本轮用户已确认 F9/F12/F2 与安全回归正常、粉红方向满意；后续只需在 V022 调整后再做新的视觉验收。
...
| V022：视觉与窗口规则对齐审查 | 0%，禁止编码 | 以优秀案例 1 和四张参考图锁定美化规格 |
