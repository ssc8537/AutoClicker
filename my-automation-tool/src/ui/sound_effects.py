...
class SoundEffects:
    ...
    def __init__(
        ...
        *,
        ...
        self._play_sound = play_sound or (winsound.PlaySound if winsound is not None else None)
        self._flags = (
    ...
    def play_started(self) -> None:
        self._play("sound-on.wav")

    def play_stopped(self) -> None:
        self._play("sound-off.wav")
    ...
    def _load_enabled(self) -> bool:
        try:
            ...
            return bool(data.get(self._SETTING_KEY, False)) if isinstance(data, dict) else False
