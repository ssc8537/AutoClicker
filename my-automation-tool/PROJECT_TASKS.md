...
> 项目名称：键盘自动化序列播放器 (MyAutoPlayer) | 最后更新：2026-07-15（审查 #4 后）
...
- [ ] 2.1 创建 src/ui/osd_window.py（OSD 浮层窗口）
- [ ] 2.2 实现 show_notification / hide_notification
- [ ] 2.3 实现自动淡出
- [ ] 2.4 settings.json 增加提示文本配置项
- [ ] 2.5 热键回调中调用 OSD 显示
- [ ] 2.6 设置开关
- [ ] 2.7 手动测试验证
